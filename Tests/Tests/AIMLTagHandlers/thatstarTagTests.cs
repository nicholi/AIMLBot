...
namespace Tests.AIMLTagHandlers
{
    ...
    public class thatstarTagTests
    {
        ...
        public void setupMockObjects()
        {
            ...
            this.mockRequest.ThatStar.Insert(0, "first star");
            this.mockRequest.ThatStar.Insert(0, "second star");
        ...
        public void testAtomic()
        {
            ...
            this.mockBotTagHandler = new AIMLbot.AIMLTagHandlers.thatstar(this.mockBot, this.mockUser, this.mockRequest, this.mockResult, testNode);
