...
namespace Tests.AIMLTagHandlers
{
    ...
    public class genderTagTests
    {
        ...
        public void testNonAtomic()
        {
            ...
            this.mockBotTagHandler = new AIMLbot.AIMLTagHandlers.gender(this.mockBot, this.mockUser, this.mockRequest, this.mockResult, testNode);
        ...
        public void testAtomic()
        {
            ...
            this.mockBotTagHandler = new AIMLbot.AIMLTagHandlers.gender(this.mockBot, this.mockUser, this.mockRequest, this.mockResult, testNode);
            this.mockRequest.InputStar.Insert(0, " HE SHE TO HIM TO HER HIS HER HIM ");
