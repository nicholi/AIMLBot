...
namespace Tests.AIMLTagHandlers
{
    ...
    public class setTagTests
    {
        ...
        public void testWithGoodData()
        {
            ...
            this.mockBotTagHandler = new AIMLbot.AIMLTagHandlers.set(this.mockBot, this.mockUser, this.mockRequest, this.mockResult, testNode);
        ...
        public void testAbilityToRemovePredicates()
        {
            ...
            this.mockBotTagHandler = new AIMLbot.AIMLTagHandlers.set(this.mockBot, this.mockUser, this.mockRequest, this.mockResult, testNode2);
